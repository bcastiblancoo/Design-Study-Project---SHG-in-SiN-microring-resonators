...
# `BECO_PIC_Report.pdf/`: Detailed report and analysis of the results.

# `BECO_PIC_Slides-Presentation.pdf/`: Slides showing the results of the project.

# `EMode Codes/`: Scripts for sweeping and extracting modal data from straight waveguides using Lumerical EMode simulations.
...
# `Results/': Contains modal results, simulations, and plots categorized by waveguide width.
